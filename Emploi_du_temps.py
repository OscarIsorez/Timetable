...
"""
fonction qui prend en entr�e un n, nombre de semaine ? afficher et qui g�n?re les pages et le code html associ�
"""
...
"""
@param : n, nombre de semaines ? afficher, qui sera utile car �gal au num�ro de la derni?re page ? cr�er
"""
...
#     # on r�cup?re le chemin du script
#     script_directory = os.path.dirname(__file__)
...
# Supprimer les lignes en doublon du fichier 'exemple.txt' et enregistrer le r�sultat dans 'exemple_modifie.txt'
